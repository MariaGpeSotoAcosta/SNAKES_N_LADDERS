...
players1.setPlayers(2);
    ...
    int penaltySnakes = 3;
    int rewardLadder = 3;
    board1.setBoardVAL(penaltySnakes,rewardLadder,board1.getBoard());
    ...
    if(x=='S'){
       ...
       if(gamemode == "manual"){
        manual.startM(board1.getBoard(),board1.getBoardVAL(),players1.getPlayers(),turnsP,penaltySnakes,rewardLadder);

       }
    if(gamemode == "auto"){
    autom.startA(board1.getBoard(),board1.getBoardVAL(),players1.getPlayers(),turnsP,penaltySnakes,rewardLadder);
    }
    }
    if(x=='M'){
    int modeGAME;
